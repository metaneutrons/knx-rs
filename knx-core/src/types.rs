...
pub struct InvalidWireValue;

impl core::fmt::Display for InvalidWireValue {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str("invalid KNX wire value")
    }
}

impl core::error::Error for InvalidWireValue {}
