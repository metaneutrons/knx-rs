...
impl TryFrom<u8> for MessageCode {
    ...
    fn try_from(v: u8) -> Result<Self, Self::Error> {
        match v {
            0x11 => Ok(Self::LDataReq),
            0x2E => Ok(Self::LDataCon),
            0x29 => Ok(Self::LDataInd),
            0xFC => Ok(Self::PropReadReq),
            0xFB => Ok(Self::PropReadCon),
            0xF6 => Ok(Self::PropWriteReq),
            0xF5 => Ok(Self::PropWriteCon),
            0xF7 => Ok(Self::PropInfoInd),
            0xF8 => Ok(Self::FuncPropCommandReq),
            0xF9 => Ok(Self::FuncPropStateReadReq),
            0xFA => Ok(Self::FuncPropCon),
            0xF1 => Ok(Self::ResetReq),
            0xF0 => Ok(Self::ResetInd),
